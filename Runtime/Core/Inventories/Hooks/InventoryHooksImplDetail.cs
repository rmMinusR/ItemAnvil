...
namespace rmMinusR.ItemAnvil.Hooks.Inventory
{
    ...
    public class InventoryHooksImplDetail : ScriptableObject
    {
        ...
        public HookPoint<RemoveItemHook   > removeItem    = new HookPoint<RemoveItemHook   >();
        ...
        public QueryEventResult ExecuteRemoveItems      (ReadOnlyInventorySlot slot, ItemStack removed, ReadOnlyItemStack originalRemoved, object cause) => removeItem   .Process(hook => hook(slot, removed, originalRemoved, cause));
