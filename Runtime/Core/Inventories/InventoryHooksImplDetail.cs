...
namespace rmMinusR.ItemAnvil.Hooks.Inventory
{
    ...
    /// instance before copying values into it. This breaks dynamically-bound events,
    /// both C#'s `event` keyword and UnityEvents.
    /// 
    /// This class works around that limitation by holding events for an Inventory
    /// implementation, allowing hooks to persist across serialization.
    /// 
    /// <code>
