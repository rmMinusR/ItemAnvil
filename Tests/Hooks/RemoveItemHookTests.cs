...
namespace rmMinusR.ItemAnvil.Tests
{
    ...
    public class RemoveItemHookTests
    {
        ...
        public void RemoveItemHook_TryRemove_Fires()
        {
            ...
            int timesFired = 0;
            inv.Hooks.TryRemoveItem.InsertHook((ReadOnlyInventorySlot slot, ItemStack removed, ReadOnlyItemStack originalRemoved, object cause) => {
                timesFired++;
        ...
        public void RemoveItemHook_TryRemove_Skips()
        {
            ...
            inv.Hooks.TryRemoveItem.InsertHook((ReadOnlyInventorySlot slot, ItemStack removed, ReadOnlyItemStack originalRemoved, object cause) => slot.ID == 0 ? QueryEventResult.Deny : QueryEventResult.Allow, int.MaxValue);
        ...
        public void PostRemoveHook_TryRemove_Fires()
        {
            ...
            (Inventory inv, Item item) = Arrange();
            int timesFired = 0;
            inv.Hooks.PostRemove.InsertHook((object cause) => {
                timesFired++;
            }, int.MaxValue);
